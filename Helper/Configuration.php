...
class Configuration
{
    const XML_PATH_SHOW_REGISTER_SECTION = 'checkout/general/show_register_section';
    const XML_PATH_SHOW_EMAIL_FIELD_FOR_GUEST = 'checkout/general/show_email_field_for_guest';
